                    ...
                    <form method="POST" action="{{ url('checkout/submit') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="pembayaran">
                                <option value="Cash">Cash (Pembayaran saat pengambilan tiket)</option>
                                <option value="OVO">OVO</option>
                            </select>
                        </div>
                        <br>
                        <label>Tiket Event Yang Dipesan :</label>
                        <table class="table">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-primary">
                    <a>Harap bukti transaksi ditunjukkan saat penukaran tiket !</a>
                </div>
